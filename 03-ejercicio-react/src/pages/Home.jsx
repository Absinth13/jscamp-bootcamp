...
export function HomePage() {
  ...
  const handleSearch = (event) =>{
    ...
    //si no tenemos un termino de busqueda 
    :'/search'
  ...
  return (
    <main>
      <section>
         <img
          title="Oficina"
          alt="Una fotografía de un grupo de personas trabajando en sus respectivas computadoras"
          src="./background.webp" width="400"/>
      ...
      <section>
        ...
        <footer>
          <article>
            <svg
              fill="currentColor" height="32" viewBox="0 0 256 256" width="32" aria-hidden="true">
